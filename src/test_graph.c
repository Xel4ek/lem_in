...
t_graph *mygraph(void)
{
	...
	ft_add_vertex_back(graph, vertex);
	ft_add_edge((t_vertex *)graph->vertex_list->content, (t_vertex *)graph->vertex_list->next->content, 0, 0);
	...
	ft_add_vertex_back(graph, vertex);
	ft_add_edge((t_vertex *)graph->vertex_list->content, (t_vertex *)graph->vertex_list->prev->content, 0, 0);
	vertex = ft_new_verex(8,"four");
	ft_add_vertex_back(graph, vertex);
	ft_add_edge((t_vertex *)graph->vertex_list->prev->prev->content, (t_vertex *)graph->vertex_list->prev->content, 0, 0);
    ft_add_edge((t_vertex *)graph->vertex_list->prev->prev->content, (t_vertex *)graph->vertex_list->prev->prev->prev->content, 0, 0);
